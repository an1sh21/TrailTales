...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v120</b> with <b>androidx.compose.material3:material3</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV120() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.material3.v120");
        }
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v150</b> with <b>androidx.compose.ui:ui</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV150() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.ui.v150");
        }
    ...
    public static class AndroidxUiToolingPreviewLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v150</b> with <b>androidx.compose.ui:ui-tooling-preview</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV150() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.ui.tooling.preview.v150");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ui</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiToolingPreview</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
